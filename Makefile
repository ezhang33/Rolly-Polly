...
STUDENT_LIBS = list color vector polygon body scene forces collision images text sounds
...
# bin/test_suite_%: out/test_suite_%.o out/test_util.o $(STUDENT_OBJS) $(STAFF_OBJS) #out/sdl_wrapper.o
# 	$(CC) $(CFLAGS) $(LIBS) $^ -o $@
